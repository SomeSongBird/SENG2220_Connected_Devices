...
def main():
    ...
    while True:
        #copied from other file
        temperatureC = (chan.voltage-.5)*100
        temperatureF = (temperatureC * 9.0 / 5.0) + 32.0

        print("The temperature around the arduino is: "+str(temperatureF)) #changed output name
        
        formated = {                  #this is all the data that i want to store
            "user":"Chris",
            "sensor":"1",
            "temperature":temperatureF #changed output name
            }  
